...
- As of 2026-09-03 study-build snapshot: live Nearby is town, then Nominatim, then OSM behind `LIVE_NEARBY` (no GPS); My Health/Learn/More remain largely static demo; Help Now dialers gated by `HELP_NOW_LIVE`; encrypted My Health / PIN / working erase are spec targets, not yet implemented. Re-check the app before relying on this bullet.
