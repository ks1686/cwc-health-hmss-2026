...
Do not paste large copyrighted excerpts here. Citation keys live in `references.bib`.
...
- Peer / partner AI tooling one-pagers — CWC Health study build is not an LLM product; keep out until a careful comparison is warranted
- Qualitative-methods process papers better suited to Method than Related Work
- Adjacent community-engagement protocols optional later
- Off-topic homelessness / violence perspectives for this navigation/privacy framing
- Duplicate PDFs of the same Dwyer article
